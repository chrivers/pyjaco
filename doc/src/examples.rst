...
**source**: `examples/gol.py <http://github.com/qsnake/py2js/blob/master/examples/gol.py>`_
...
**source**: `examples/ui.py <http://github.com/qsnake/py2js/blob/master/examples/ui.py>`_
...
**source**: `examples/triangulation.py <http://github.com/qsnake/py2js/blob/master/examples/triangulation.py>`_
