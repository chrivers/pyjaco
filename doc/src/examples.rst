...
**source**: `examples/gol.py <http://github.com/mattpap/py2js/blob/master/examples/gol.py>`_
...
**source**: `examples/ui.py <http://github.com/mattpap/py2js/blob/master/examples/ui.py>`_
